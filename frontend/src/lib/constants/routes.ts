...
export const ROUTES = {
  ...
  // Paid Resource Downloads — the "who's paying whom" order-summary page,
  // shown before redirecting to the payment gateway (Phase B).
  checkout: (slug: string) => `/resources/${slug}/checkout`,
  datasets: '/datasets',
  ...
  adminSettingsFonts: '/admin/settings/fonts',
  adminSettingsStatCards: '/admin/settings/stat-cards',
  adminSettingsPayments: '/admin/settings/payments',
